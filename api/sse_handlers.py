...
async def classic_event_generator(query: str, use_hyde: bool, provider: str = "gemini", model: str = None, chat_id: str = None, persona_id: str = "default", temp_file_path: str = None, temp_file_name: str = None, use_web_search: bool = False):
...
async def agentic_event_generator(query: str, use_hyde: bool, provider: str = "gemini", model: str = None, chat_id: str = None, persona_id: str = "default", temp_file_path: str = None, temp_file_name: str = None, use_web_search: bool = False):
