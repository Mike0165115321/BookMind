...
- อย่าเพิ่งตอบว่าไม่มีข้อมูล
- ให้ใช้ทักษะการวิเคราะห์และเชื่อมโยง (Synthesis) จากหลักการพื้นฐานในหนังสือที่ดึงมา
- อธิบายว่าหลักการดังกล่าวสามารถนำมาประยุกต์ใช้กับคำถามของผู้ได้อย่างไรอย่างมีเหตุผล
- เน้นการให้คำแนะนำที่นำไปปฏิบัติได้ (Actionable Insights) แม้ข้อมูลต้นฉบับจะไม่ได้ระบุถึงสถานการณ์นั้นโดยตรง
